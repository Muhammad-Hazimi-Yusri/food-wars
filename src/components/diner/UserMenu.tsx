...
import { Settings, BookOpen, ShoppingCart, Bot, ChefHat, CalendarDays, BarChart2, CookingPot } from "lucide-react";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem asChild>
          <Link href="/cook-now" className="flex items-center gap-2">
